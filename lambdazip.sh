...
(echo "### Install cli53"; sudo wget https://github.com/barnybug/cli53/releases/download/0.8.7/cli53-linux-386; sudo chmod +x $HOME/cli53-linux-386; sudo zip -r9 $zipfile cli53-linux-386)
